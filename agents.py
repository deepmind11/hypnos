...
1. User requests coming to you (these will often be shorter in length)
2. Stories generated by the system going back to the user (these will be longer in length ~500 words)
